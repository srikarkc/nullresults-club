    ...
    <main className="min-h-screen flex flex-col items-center justify-center px-4">
      <div className="max-w-xl text-center space-y-4">
        ...
        <p className="text-sm text-gray-400">
          A home for all the experiments that didn&apos;t quite work out — but
          still taught you something.
        </p>

        <p className="text-sm text-gray-300">
          Everyone publishes their successes. Here we publish the crashes, the
          flops, the null results, and the &quot;turns out that doesn&apos;t
          work&quot; moments.
        </p>
